 ...
 */
package org.apache.hadoop.fuzzing;
...
class JavaSerializationFuzzer {
    ...
    void myFuzzTest(FuzzedDataProvider data) {
        ...
        try {
            ...
            deserializer.close();
        } catch (IOException | ClassCastException | ArrayIndexOutOfBoundsException | NegativeArraySizeException | NullPointerException e) {
